...
public class DriveSubsystem extends SubsystemBase {
  ...
  PWMTalonSRX rightTalon = new PWMTalonSRX(RobotMap.rightTalonChannle);
  MotorControllerGroup right_ControllerGroup = new MotorControllerGroup(frontRight, middleRight, backRight, rightTalon);
  ...
  MotorControllerGroup left_ControllerGroup = new MotorControllerGroup(frontLeft, middleLeft, backLeft, leftTalon);
